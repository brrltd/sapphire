...
has_one can also be polymorphic, which allows any type of object to be associated.
...
Defines a 1-to-1 relationship with another object. The related object will define
the other end of the relationship with a has_one, and will hold the ID of the
object defining the belongs_to.

Similarly with has_many, dot notation can be used to specify the has_one which
