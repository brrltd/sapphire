...
class DB {
	...
	public static function requireIndex($table, $index, $spec) {
		return self::getSchema()->requireIndex($table, $index, $spec);
	}
	...
	public static function dontRequireTable($table) {
		return self::getSchema()->dontRequireTable($table);
	}
	...
	public static function dontRequireField($table, $fieldName) {
		return self::getSchema()->dontRequireField($table, $fieldName);
	}
	...
	public static function alteration_message($message,$type="") {
		return self::getSchema()->alterationMessage($message, $type);
	}
