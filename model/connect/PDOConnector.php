...
class PDOConnector extends DBConnector {
	...
	public function connect($parameters) {
		...
		$dsn = "{$parameters['driver']}:host={$parameters['server']}";
		...
		$this->pdoConnection = new PDO($dsn, $parameters['username'], $parameters['password'], $options);
	}
	...
	protected function hasError($resource) {
		...
		// Skip the default 'ok' error code
		return $code !== '00000';
	}
