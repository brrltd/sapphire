...
abstract class Object {
	 ...
	 * This supports backwards-compatible format (static Object::has_extension($requiredExtension)) and
	 * new format ($object->has_extension($class, $requiredExtension))
	 * @param string $classOrExtension if 1 argument supplied, the class name of the extension to check for;
	 * if 2 supplied, the class name to test
